...
export const pageSchemas = {
  ...
  fnb: {
    Pablo: [
      { title: 'Sales', rows: [['Gross Sales', 160000], ['Covers', 135], ['Avg Bill', 1185], ['Combo Sales %', 28, 'max'], ['Beverage Attach Rate', 1.5], ['Table Turnover', 50], ['Core 4 Revenue %', 65], ['Lunch Revenue', 55000], ['Supper Revenue', 25000], ['Dinner Revenue', 80000]] },
