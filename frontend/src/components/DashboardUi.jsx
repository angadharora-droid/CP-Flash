  ...
  if (!visibleRows.length) {
    return (
      <div className="flex flex-col items-center justify-center py-10 text-center">
        <span className="material-symbols-outlined mb-3 text-[36px] text-on-surface-variant/25" aria-hidden>monitoring</span>
        <div className="text-[13px] font-semibold text-on-surface-variant">No KPI data yet</div>
        <div className="mt-1 text-[12px] text-on-surface-variant/60">Data will appear once the report is imported.</div>
      </div>
    );
  }
  return (
    <div className="scroll-touch w-full overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm">
      <table className="w-full min-w-[480px] border-separate border-spacing-0 md:min-w-full">
        <thead>
          <tr className="bg-slate-50">
            ...
            <th className="border-b border-slate-200 px-3 py-2 text-left text-[10px] font-extrabold uppercase tracking-[0.14em] text-slate-500 sm:px-4 sm:py-3 sm:text-[10.5px]">
              Status
            </th>
          </tr>
        </thead>
